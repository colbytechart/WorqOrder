...
| Work Type, Billing Status, and Mileage | Task metadata/repository/Create/Edit UI | persistence/migration, nullable history, Billable default, canonical decimal/input validation, ViewModel, Compose, and rollover coverage | Create/edit workflow including migrated blank status | Billing Status implemented in M27 first phase; final verification pending |
