...
The owner published `0.6.0`/code 6 and independently downloaded and manually verified the release
APK. It adds the versioned compressed backup format, strict validation, atomic replacement/recovery
engine, one app-private rolling restore point, Google ownership protections, and the **Backup &
Restore** Settings workflow. All non-deferred release gates passed. See the
[v0.6.0 roadmap](docs/V0_6_MILESTONE_PROMPTS.md) and
[Milestone 55 decision](docs/MILESTONE_55C_RELEASE_DECISION.md). The prior environment-teardown
work remains deferred to Milestones 56–57 and has not started.
