...
|---|---|---|---|---|
| Logical versioned two-entry ZIP | versioned DTO/strict JSON codec/manifest foundation in M50; bounded writer in M51; parser in M52 | DTO/strict-shape and production exact-entry/Deflate/byte-count/SHA-256/bounds/cancellation tests pass | inspect/share/import created file after Settings integration | Partial: logical model and writer pass; archive reader/import remain |
| Complete portable state and exclusions | logical DTO/exclusion allowlist in M50; Room snapshot and portable preference adapters in M51; replacement in M52 | complete/empty/Unicode fixtures, forbidden-field audit, and Room-backed live snapshot/exclusion tests pass | populated cross-device comparison after import exists | Partial: capture/exclusions pass; restore equivalence remains |
